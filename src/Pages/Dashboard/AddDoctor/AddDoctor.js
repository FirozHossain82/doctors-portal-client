...
const AddDoctor = () => {
  ...
  const {data: specialties, isLoading} = useQuery({
    queryKey: ['specialty'],
    queryFn: async () =>{
        const res = await fetch('https://doctors-portal-server-delta-virid.vercel.app/appointmentSpecialty');
  ...
  const handleAddDoctor = (data) => {
    ...
    .then(imgData =>{
      ...
      if(imgData.success){
        ...
        fetch('https://doctors-portal-server-delta-virid.vercel.app/doctors', {
          method: 'POST',
          headers: {
